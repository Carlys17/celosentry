...
Validation checklist: test zero, one-unit, maximum, and non-divisible quote values; compare verifier output with the actual token transfer; assert that the facilitator cannot create or lose value through repeated partial settlement. This is a demo finding for the CeloSentry workflow and should be independently validated against the target facilitator implementation.`
  ...
  'R-003': {
    ...
    priceCusd: '0.01', summary: 'A callable reward-claim path does not bind the signed authorization to the intended beneficiary.',
  ...
  'R-004': {
    ...
    priceCusd: '0.01', summary: 'The emergency pause stops deposits but leaves an alternate withdrawal route callable.',
  ...
  'R-005': {
    ...
    priceCusd: '0.01', summary: 'A collateral operation accepts an oracle round outside the intended freshness window.',
  ...
  'R-006': {
    ...
    priceCusd: '0.01', summary: 'The rebalance helper executes a swap without a minimum output bound supplied by the caller.',
  ...
  'R-007': {
    ...
    priceCusd: '0.01', summary: 'Payout signatures use a shared nonce namespace across assets and recipients.',
  ...
  'R-008': {
    ...
    priceCusd: '0.01', summary: 'Integer truncation leaves small unaccounted fee dust on repeated refunds.',
  ...
  'R-009': {
    ...
    priceCusd: '0.01', summary: 'An administrator can configure a zero token or recipient address.',
  ...
  'R-010': {
    ...
    priceCusd: '0.01', summary: 'Settlement events do not expose the final recipient used by downstream indexers.',
  ...
  'R-011': {
    ...
    priceCusd: '0.01', summary: 'The upgrade handoff can leave a transient state where both old and new administrators can authorize upgrades.',
  ...
  'R-012': {
    ...
    priceCusd: '0.01', summary: 'A recovery function performs an external token callback before updating its internal accounting.',
