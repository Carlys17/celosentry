...
export const TARGETS = {
  'R-001': { project: 'CeloSentry Demo Vault', contract: '0x29f065288a8d56cC2a6afA4ce1d64C80aCb2381e', network: 'celo-mainnet', component: 'src/DemoVault.sol (ApprovalStore)', commit: 'demo-lab@1' },
  'R-002': { project: 'CeloSentry Demo Vault', contract: '0x29f065288a8d56cC2a6afA4ce1d64C80aCb2381e', network: 'celo-mainnet', component: 'src/DemoVault.sol (FeeMath)', commit: 'demo-lab@1' },
  'R-003': { project: 'CeloSentry Demo Vault', contract: '0x29f065288a8d56cC2a6afA4ce1d64C80aCb2381e', network: 'celo-mainnet', component: 'src/DemoVault.sol (ClaimRouter)', commit: 'demo-lab@1' },
  'R-004': { project: 'CeloSentry Demo Vault', contract: '0x29f065288a8d56cC2a6afA4ce1d64C80aCb2381e', network: 'celo-mainnet', component: 'src/DemoVault.sol (WithdrawalRouter)', commit: 'demo-lab@1' },
  'R-005': { project: 'CeloSentry Demo Vault', contract: '0x29f065288a8d56cC2a6afA4ce1d64C80aCb2381e', network: 'celo-mainnet', component: 'src/DemoVault.sol (CollateralOracle)', commit: 'demo-lab@1' },
  'R-006': { project: 'CeloSentry Demo Vault', contract: '0x29f065288a8d56cC2a6afA4ce1d64C80aCb2381e', network: 'celo-mainnet', component: 'src/DemoVault.sol (RouteExecutor)', commit: 'demo-lab@1' },
  'R-007': { project: 'CeloSentry Demo Vault', contract: '0x29f065288a8d56cC2a6afA4ce1d64C80aCb2381e', network: 'celo-mainnet', component: 'src/DemoVault.sol (SignatureVault)', commit: 'demo-lab@1' },
  'R-008': { project: 'CeloSentry Demo Vault', contract: '0x29f065288a8d56cC2a6afA4ce1d64C80aCb2381e', network: 'celo-mainnet', component: 'src/DemoVault.sol (RefundMath)', commit: 'demo-lab@1' },
  'R-009': { project: 'CeloSentry Demo Vault', contract: '0x29f065288a8d56cC2a6afA4ce1d64C80aCb2381e', network: 'celo-mainnet', component: 'src/DemoVault.sol (ConfigStore)', commit: 'demo-lab@1' },
  'R-010': { project: 'CeloSentry Demo Vault', contract: '0x29f065288a8d56cC2a6afA4ce1d64C80aCb2381e', network: 'celo-mainnet', component: 'src/DemoVault.sol (SettlementEmitter)', commit: 'demo-lab@1' },
  'R-011': { project: 'CeloSentry Demo Vault', contract: '0x29f065288a8d56cC2a6afA4ce1d64C80aCb2381e', network: 'celo-mainnet', component: 'src/DemoVault.sol (UpgradeProxy)', commit: 'demo-lab@1' },
  'R-012': { project: 'CeloSentry Demo Vault', contract: '0x29f065288a8d56cC2a6afA4ce1d64C80aCb2381e', network: 'celo-mainnet', component: 'src/DemoVault.sol (RescueModule)', commit: 'demo-lab@1' },
};
...
Validation checklist: test zero, one-unit, maximum, and non-divisible quote values; compare verifier output with the actual token transfer; assert that the facilitator cannot create or lose value through repeated partial settlement. This is a demo finding for the CeloSentry workflow and should be independently validated against the target facilitator implementation.`
  ...
  'R-003': {
    ...
    priceCusd: '0.50', summary: 'A callable reward-claim path does not bind the signed authorization to the intended beneficiary.',
  ...
  'R-004': {
    ...
    priceCusd: '0.50', summary: 'The emergency pause stops deposits but leaves an alternate withdrawal route callable.',
  ...
  'R-005': {
    ...
    priceCusd: '0.30', summary: 'A collateral operation accepts an oracle round outside the intended freshness window.',
  ...
  'R-006': {
    ...
    priceCusd: '0.30', summary: 'The rebalance helper executes a swap without a minimum output bound supplied by the caller.',
  ...
  'R-007': {
    ...
    priceCusd: '0.30', summary: 'Payout signatures use a shared nonce namespace across assets and recipients.',
  ...
  'R-008': {
    ...
    priceCusd: '0.25', summary: 'Integer truncation leaves small unaccounted fee dust on repeated refunds.',
  ...
  'R-009': {
    ...
    priceCusd: '0.25', summary: 'An administrator can configure a zero token or recipient address.',
  ...
  'R-010': {
    ...
    priceCusd: '0.25', summary: 'Settlement events do not expose the final recipient used by downstream indexers.',
  ...
  'R-011': {
    ...
    priceCusd: '0.50', summary: 'The upgrade handoff can leave a transient state where both old and new administrators can authorize upgrades.',
  ...
  'R-012': {
    ...
    priceCusd: '0.30', summary: 'A recovery function performs an external token callback before updating its internal accounting.',
...
export function formatReportMarkdown(id, report) {
  ...
  return [
    ...
    `| Commit | \`${t.commit || 'n/a'}\` |`,
    '',
    '> Demo Lab on Celo mainnet. Every finding uses this single in-repo contract; the file is public in /contracts and the address resolves on CeloScan.',
    '',
    '## Summary',
    '',
    report.summary,
